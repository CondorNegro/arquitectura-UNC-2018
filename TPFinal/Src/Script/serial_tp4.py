...
def fileWriter (file_name, texto):
	try:
		file = open (file_name, 'w')
		file.write (texto)
		file.close()
		print 'Se escribio correctamente el archivo.'
	except:
		print ('Error en el manejo del archivo.')
		print ('Fin.')
		exit(1)
...
def recibirDatosFromFPGA ():
	...
	while (flag_receive):
		...
		#Memoria
			...
			if ((contador_primer_dato_mem % 3) != 0):
