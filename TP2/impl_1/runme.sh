...
HD_PWD='/home/matias/tp2_uart_arqui/tp2_uart_arqui.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_arquitectura.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_arquitectura.tcl -notrace
